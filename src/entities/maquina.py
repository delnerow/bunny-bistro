from src.entities.prato import Prato
...
class Tabua(Maquina):
    def __init__(self,gc,x,y):
        self.image=pygame.image.load('assets\\images\\cozinha\\tabua.png').convert_alpha();
        self.image= pygame.transform.scale(self.image, (50, 50))
        super().__init__(gc,self.image,x,y)
        self.position = 4
        self.sound = pygame.mixer.Sound('assets\\sounds\\cortar.mp3')
...
class Batedeira(Maquina):
    def __init__(self,gc,x,y):
        self.image=pygame.image.load('assets\\images\\cozinha\\batedeira.png').convert_alpha();
        self.image= pygame.transform.scale(self.image, (40, 40))
        super().__init__(gc,self.image,x,y)
        self.position = 3
        self.sound = pygame.mixer.Sound('assets\\sounds\\bater.mp3')
...
class Forno(Maquina):
    def __init__(self,gc,x,y):
        self.image=pygame.image.load('assets\\images\\cozinha\\fogoes\\fogao_nivel1.png').convert_alpha()
        self.image= pygame.transform.scale(self.image, (64, 64))
        super().__init__(gc,self.image,x,y)
        self.position = 2
        self.sound = pygame.mixer.Sound('assets\\sounds\\forno.mp3')
    def cozinhar(self):
        self.sound.play()
        for i in range(len(self.prato_atual.ingredientes)):
