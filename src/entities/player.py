...
from src.entities.prato import *
...
class Player:
    def __init__(self):
        ...
        self.sheet = pygame.image.load("assets\\images\\coelinho.png").convert_alpha()
        ...
        pos_fogao = Vector2(64*8.4, 64*1.5)     #2
        pos_batedeira = Vector2(64*5.63,64*1.5) #3
        pos_tabua = Vector2(64*13.50, 64*1.5)         #4
        pos_prato = Vector2(64*1.5, 64*3)         #5
        ...
        self.prepGunSound = pygame.mixer.Sound("assets\\sounds\\gunPrepare.mp3")
        self.shootSound = pygame.mixer.Sound("assets\\sounds\\gunShoot.mp3")
