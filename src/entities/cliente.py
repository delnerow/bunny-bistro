...
class Cliente(ClickableSprite):
    def __init__(self,gc,x,y,paciencia, pedido, especie,fila):
        ...
        self.image = pygame.image.load("assets\\images\\clientes\\"+diretorio).convert_alpha()
        ...
        self.balao_image = pygame.image.load("assets\\images\\clientes\\balao.png").convert_alpha()  # carrega a imagem do balão
