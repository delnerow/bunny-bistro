...
class IntroAnimation:
    def __init__(self, screen):
        ...
        self.logo = pygame.image.load("assets\\images\\animacoes\\logo.png").convert_alpha()
        self.logo = pygame.transform.scale_by(self.logo, 0.5)

        self.spritesheet = pygame.image.load("assets\\images\\animacoes\\animacao.png").convert_alpha()
        self.num_frames = 5
