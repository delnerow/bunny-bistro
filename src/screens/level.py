import pygame, sys
from src.systems.ClienteSpawner import ClienteSpawner
from src.systems.fila import Fila
from src.systems.filaMesa import FilaMesa
from src.ui.introAnimation import IntroAnimation
from src.entities.mesa import Mesa
from src.entities.bancada import Bancada
from src.entities.cliente import Cliente
from src.ui.colaReceitas import ColaUI
from src.ui.pratoDIsplay import PratoDisplay
import src.entities.maquina as maquina
from src.entities.armazem import Geladeira, Despensa
from src.entities.lixo import Lixo
from src.ui.window import Window
from src.entities.barata import Barata
...
class Level:
    ...
    def reset(self):
        ...
        self.background = pygame.image.load("assets\\images\\cozinha\\cozinha_nivel1.png").convert_alpha()
        ...
        self.font = pygame.font.Font("assets\\fonts\\DigitalDismay.otf", 36)
        ...
        self.gc.music_Manager.tocar_musica('assets\\sounds\\music.mp3')
        self.musicNow = 0
    ...
    def update_music(self):
        if self.time_remaining <= self.time_init/2 and self.musicNow == 0:
            ...
            pygame.mixer.music.load('assets\\sounds\\music_fast.mp3')  # Carrega a nova música
        ...
        if self.time_remaining <= self.time_init/4 and self.musicNow == 1:
            self.musicNow = 2
            pygame.mixer.music.fadeout(100)  # Fadeout da música atual (1 segundo)
            pygame.mixer.music.load('assets\\sounds\\music_muitofast.mp3')  # Carrega a nova música
            pygame.mixer.music.play(-1, fade_ms=100)  # Toca a nova música com fadein (1 segundo)
