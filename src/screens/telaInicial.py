...
class TelaInicial:
    def __init__(self, gc):
        self.gc = gc
        self.background = pygame.image.load("assets\\images\\tela-inicial\\tela-fundo.png")
        self.background = pygame.transform.scale(self.background, (16*64, 9*64))
        self.clock = pygame.time.Clock()

        self.botao_jogar_normal = self.load_scaled("assets\\images\\tela-inicial\\botao-jogar.png", 1.5)
        self.botao_jogar_hover = self.load_scaled("assets\\images\\tela-inicial\\botao-jogar.png", 1.7)

        self.botao_instrucoes_normal = self.load_scaled("assets\\images\\tela-inicial\\botao-instrucoes.png", 1.5)
        self.botao_instrucoes_hover = self.load_scaled("assets\\images\\tela-inicial\\botao-instrucoes.png", 1.7)

        self.botao_sair_normal = self.load_scaled("assets\\images\\tela-inicial\\botao-sair.png", 1.5)
        self.botao_sair_hover = self.load_scaled("assets\\images\\tela-inicial\\botao-sair.png", 1.7)
    ...
    def run(self):
        running = True
        self.gc.music_Manager.tocar_musica("assets\\sounds\\telaStart.mp3")
        while running:
...
class TelaInstrucoes:
    def __init__(self, gc):
        self.gc = gc
        self.background = pygame.image.load("assets\\images\\tela-inicial\\tela-instrucoes.png")  # Imagem da tela de instruções
        self.background = pygame.transform.scale(self.background, (16*64, 9*64))
        self.clock = pygame.time.Clock()

        self.botao_voltar_normal = self.load_scaled("assets\\images\\tela-inicial\\botao-voltar.png", 1.5)
        self.botao_voltar_hover = self.load_scaled("assets\\images\\tela-inicial\\botao-voltar.png", 1.7)
