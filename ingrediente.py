...
class Tomate(Ingrediente):
    def __init__(self,gc,x,y):
        self.image=pygame.image.load('images\\pratos\\ingredientes\\tomate.png').convert_alpha();
...
class Cebola(Ingrediente):
    def __init__(self,gc,x,y):
        self.image=pygame.image.load('images\\pratos\\ingredientes\\cebola.png').convert_alpha()
        self.image = pygame.transform.scale_by(self.image, 3)
...
class Grao(Ingrediente):
    def __init__(self,gc, x, y):
        self.image=pygame.image.load('images\\pratos\\ingredientes\\batata.png').convert_alpha()
        self.image = pygame.transform.scale_by(self.image, 3)
...
class Farinha(Ingrediente):
    def __init__(self,gc, x, y):
        self.image=pygame.image.load('images\\pratos\\ingredientes\\acucar.png').convert_alpha()
        self.image = pygame.transform.scale_by(self.image, 3)
...
class Leite(Ingrediente):
    def __init__(self,gc, x, y):
        self.image=pygame.image.load('images\\pratos\\ingredientes\\leite.png').convert_alpha()
        self.image = pygame.transform.scale_by(self.image, 3)
...
class Brocolis(Ingrediente):
    def __init__(self,gc, x, y):
        self.image=pygame.image.load('images\\pratos\\ingredientes\\brocolis.png').convert_alpha()
        self.image = pygame.transform.scale_by(self.image, 3)
